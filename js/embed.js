! function(e) {
    ...
    "7Qib": function(t, n, e) {
        ...
        var a, s = (a = {}, ["error", "log", "info"].forEach(function(n) {
            a[n] = function(t) {
                "info" === n ? console[n]("%c".concat(f(t)), "color: #FE2C55") : console[n](f(t))
            }
        }), a);
    ...
    Afnz: function(t, n, e) {
        ...
        t.exports = function(t, n, e, r, o, i, u) {
            ...
            if (m && (f = P(m.call(new t))) !== Object.prototype && f.next && (E(f, l, !0), b || "function" == typeof f[F] || k(f, F, w)), p && d && d.name !== A && (h = !0, y = function() {
                    return d.call(this)
                }), b && !u || !S && !h && v[F] || k(v, F, y), j[n] = y, j[l] = w, o)
                if (a = {
                        values: p ? y : c(A),
                        keys: i ? y : c("keys"),
                        entries: g
                            ...
                            value: function() {
                                ...
                                return regeneratorRuntime.async(function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        ...
                                        case 2:
                                            return n = t.sent, e = n.libVersion, r = void 0 === e ? i.d : e, t.abrupt("return", r);
                                        case 6:
                                        case "end":
                                            return t.stop()
                                    }
