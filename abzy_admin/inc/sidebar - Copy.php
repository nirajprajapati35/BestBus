...
<li class=" nav-item"><a href="#"><i class="icon-stack-2"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Bike Model</span></a>
            <ul class="menu-content">
                <li><a href="bike_model/bike_model_dashboard.php" data-i18n="nav.page_layouts.1_column" class="menu-item"><i class="icon-chevron-right"></i> Bike Model Dashboard</a> </li>
            </ul>
          </li>  
...
<li class=" nav-item"><a href="bikemodel_mapping_color/bikemodel_mapping_color.php" class="<?php if($bikemodelmappingcolor  == 1 ) {echo "active" ;}?>"><i class="icon-stack-2"></i></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Bike Model Mapping Color</span></a>  
   </li>
